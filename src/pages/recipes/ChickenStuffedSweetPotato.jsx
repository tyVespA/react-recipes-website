...
import Image from "../../assets/chicken-stuffed-sweet-potato.png";
import AuthorPfp from "../../components/AuthorPfp";
import RecipeStats from "../../components/RecipeStats";

function ChickenStuffedSweetPotato() {
  return (
    <>
      <div
      ...
      <div className={styles.container}>
        <h1>{RecipesList[8].name}</h1>
        <div className={styles.creator}>
          <AuthorPfp />
        </div>
        <div className={styles.stats}>
          <RecipeStats
            calories={RecipesList[8].calories}
            carbs={RecipesList[8].carbs}
            proteins={RecipesList[8].proteins}
            fats={RecipesList[8].fats}
          />
        </div>
        ...
        <iframe
          width="100%"
          height="415"
          src="https://www.youtube.com/embed/eEBRmma-TCI?start=280"
...
export default ChickenStuffedSweetPotato;
